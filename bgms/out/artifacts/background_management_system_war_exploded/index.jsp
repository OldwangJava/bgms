...
<head>
  ...
  <link rel="icon" href="${ctx}/static/bootstrap/images/logo-ico.png" type="image/ico">
  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href="index.html"> <img alt="light year admin" src="${ctx}/static/bootstrap/images/logo-sidebar.png">
        </a>
      </div>
